...
*/
@Controller
@RequestMapping("/blog/lfyContent_pi")
public class LFYProductInfoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_pi:lfyContent_pi")
    String xppContent() {
        return "blog/lfyContent_pi/lfyContent_pi";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/lfyContent_pi/edit";
    }
