...
*/
@Controller
@RequestMapping("/blog/mecoContent_av")
public class MECOAdvertisingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_av:mecoContent_av")
    String xppContent() {
        return "blog/mecoContent_av/mecoContent_av";
    }
    ...
    String add() {
        return "blog/mecoContent_av/add";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_av/edit";
    }
