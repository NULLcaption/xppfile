...
*/
@Controller
@RequestMapping("/blog/mecoContent_cp")
public class MECOMarketingPrarticlesFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_cp:mecoContent_cp")
    String xppContent() {
        return "blog/mecoContent_cp/mecoContent_cp";
    }
    ...
    String add() {
        return "blog/mecoContent_cp/add";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_cp/edit";
    }
