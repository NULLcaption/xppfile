...
*/
@Controller
@RequestMapping("/blog/xppContent_sp")
public class XPPSPFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_sp:xppContent_sp")
    String xppContent() {
        return "blog/xppContent_sp/xppContent_sp";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_sp/edit";
    }
