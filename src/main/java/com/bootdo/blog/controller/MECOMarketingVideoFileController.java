...
*/
@Controller
@RequestMapping("/blog/mecoContent_cv")
public class MECOMarketingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_cv:mecoContent_cv")
    String xppContent() {
        return "blog/mecoContent_cv/mecoContent_cv";
    }
    ...
    String add() {
        return "blog/mecoContent_cv/add";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_cv/edit";
    }
