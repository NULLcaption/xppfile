...
*/
@Controller
@RequestMapping("/blog/documents")
public class Documents4UserFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:documents:documents")
    String xppContent() {
        return "blog/documents/documents";
    }
