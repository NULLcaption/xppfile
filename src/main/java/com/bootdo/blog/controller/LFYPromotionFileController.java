...
*/
@Controller
@RequestMapping("/blog/lfyContent_p")
public class LFYPromotionFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_p:lfyContent_p")
    String xppContent() {
        return "blog/lfyContent_p/lfyContent_p";
    }
