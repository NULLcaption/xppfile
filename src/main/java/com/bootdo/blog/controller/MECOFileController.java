...
*/
@Controller
@RequestMapping("/blog/mecoContent")
public class MECOFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent:mecoContent")
    String xppContent() {
        return "blog/mecoContent/mecoContent";
    }
