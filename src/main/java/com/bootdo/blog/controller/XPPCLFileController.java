...
*/
@Controller
@RequestMapping("/blog/xppContent_cl")
public class XPPCLFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_cl:xppContent_cl")
    String xppContent() {
        return "blog/xppContent_cl/xppContent_cl";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_cl/edit";
    }
