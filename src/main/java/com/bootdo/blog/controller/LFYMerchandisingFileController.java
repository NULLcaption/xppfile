...
*/
@Controller
@RequestMapping("/blog/lfyContent_m")
public class LFYMerchandisingFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_m:lfyContent_m")
    String xppContent() {
        return "blog/lfyContent_m/lfyContent_m";
    }
