...
*/
@Controller
@RequestMapping("/blog/mecoContent_ci")
public class MECOMarketingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_ci:mecoContent_ci")
    String xppContent() {
        return "blog/mecoContent_ci/mecoContent_ci";
    }
    ...
    String add() {
        return "blog/mecoContent_ci/add";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_ci/edit";
    }
