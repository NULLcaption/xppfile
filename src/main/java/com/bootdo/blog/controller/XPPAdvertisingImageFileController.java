...
*/
@Controller
@RequestMapping("/blog/xppContent_ai")
public class XPPAdvertisingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_ai:xppContent_ai")
    String xppContent() {
        return "blog/xppContent_ai/xppContent_ai";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_ai/edit";
    }
