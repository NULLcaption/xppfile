...
*/
@Controller
@RequestMapping("/blog/xppContent_p")
public class XPPPromotionController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_p:xppContent_p")
    String xppContent() {
        return "blog/xppContent_p/xppContent_p";
    }
