...
*/
@Controller
@RequestMapping("/blog/mecoContent_m")
public class MECOMerchandisingFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_m:mecoContent_m")
    String xppContent() {
        return "blog/mecoContent_m/mecoContent_m";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_m/edit";
    }
