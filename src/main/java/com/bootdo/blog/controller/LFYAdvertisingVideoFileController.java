...
*/
@Controller
@RequestMapping("/blog/lfyContent_av")
public class LFYAdvertisingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_av:lfyContent_av")
    String xppContent() {
        return "blog/lfyContent_av/lfyContent_av";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/lfyContent_av/edit";
    }
