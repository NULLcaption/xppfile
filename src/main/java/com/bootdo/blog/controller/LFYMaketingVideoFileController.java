...
*/
@Controller
@RequestMapping("/blog/lfyContent_cv")
public class LFYMaketingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_cv:lfyContent_cv")
    String xppContent() {
        return "blog/lfyContent_cv/lfyContent_cv";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/lfyContent_cv/edit";
    }
