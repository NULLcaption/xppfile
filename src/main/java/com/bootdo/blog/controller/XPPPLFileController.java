...
*/
@Controller
@RequestMapping("/blog/xppContent_pl")
public class XPPPLFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_pl:xppContent_pl")
    String xppContent() {
        return "blog/xppContent_pl/xppContent_pl";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_pl/edit";
    }
