...
*/
@Controller
@RequestMapping("/blog/xppContent_ci")
public class XPPMarketingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_ci:xppContent_ci")
    String xppContent() {
        return "blog/xppContent_ci/xppContent_ci";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_ci/edit";
    }
