...
*/
@Controller
@RequestMapping("/blog/xppContent_cv")
public class XPPMarketingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_cv:xppContent_cv")
    String xppContent() {
        return "blog/xppContent_cv/xppContent_cv";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_cv/edit";
    }
