...
*/
@Controller
@RequestMapping("/blog/lfyContent_ai")
public class LFYAdvertisingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_ai:lfyContent_ai")
    String xppContent() {
        return "blog/lfyContent_ai/lfyContent_ai";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/lfyContent_ai/edit";
    }
