...
*/
@Controller
@RequestMapping("/blog/lfyContent_ci")
public class LFYMaketingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent_ci:lfyContent_ci")
    String xppContent() {
        return "blog/lfyContent_ci/lfyContent_ci";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/lfyContent_ci/edit";
    }
