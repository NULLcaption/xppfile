...
*/
@Controller
@RequestMapping("/blog/xppContent_av")
public class XPPAdvertisingVideoFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_av:xppContent_av")
    String xppContent() {
        return "blog/xppContent_av/xppContent_av";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/xppContent_av/edit";
    }
