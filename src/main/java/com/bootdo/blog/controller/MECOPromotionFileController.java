...
*/
@Controller
@RequestMapping("/blog/mecoContent_p")
public class MECOPromotionFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_p:mecoContent_p")
    String xppContent() {
        return "blog/mecoContent_p/mecoContent_p";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_p/edit";
    }
