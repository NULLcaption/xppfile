...
*/
@Controller
@RequestMapping("/blog/lfyContent")
public class LFYFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:lfyContent:lfyContent")
    String xppContent() {
        return "blog/lfyContent/lfyContent";
    }
