...
*/
@Controller
@RequestMapping("/blog/xppContent")
public class XPPFileController  extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent:xppContent")
    String xppContent() {
        return "blog/xppContent/xppContent";
    }
