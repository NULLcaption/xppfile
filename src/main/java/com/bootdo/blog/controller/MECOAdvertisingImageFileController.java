...
*/
@Controller
@RequestMapping("/blog/mecoContent_ai")
public class MECOAdvertisingImageFileController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:mecoContent_ai:mecoContent_ai")
    String xppContent() {
        return "blog/mecoContent_ai/mecoContent_ai";
    }
    ...
    String add() {
        return "blog/mecoContent_ai/add";
    }
    ...
    String edit(@PathVariable("bvid") Long bvid, Model model) {
        ...
        return "blog/mecoContent_ai/edit";
    }
