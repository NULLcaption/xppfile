...
*/
@Controller
@RequestMapping("/blog/xppContent_m")
public class XPPMerchandisingController extends BaseController{
     ...
     */
    @GetMapping()
    @RequiresPermissions("blog:xppContent_m:xppContent_m")
    String xppContent() {
        return "blog/xppContent_m/xppContent_m";
    }
